...
import { api, setAuthorizationHeader, authService } from '@/services'
...
function AuthProvider(props: Props) {
  ...
  async function signIn(params: SignInCredentials) {
    ...
    if (!result.ok) return result.error as AxiosError

    const { token, refreshToken, permissions, roles } = result.data
